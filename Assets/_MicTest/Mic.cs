...
namespace Adrenak.UniMic {
    ...
    public class Mic : MonoBehaviour {
        ...
        int m_SampleCount = 0;
        private Coroutine readRawAudioRoutine;
        #endregion
        ...
        public void StartRecording(int frequency = 16000, int sampleLen = 10) {
            ...
            AudioClip = Microphone.Start(CurrentDeviceName, true, 100, Frequency);
            Sample = new float[Frequency / 1000 * SampleDurationMS * AudioClip.channels];

            //m_AudioSource.clip = Clip;

            readRawAudioRoutine = StartCoroutine(ReadRawAudio());
        ...
        public void StopRecording() {
            ...
            StopCoroutine(readRawAudioRoutine);
        ...
        {
            return Microphone.GetPosition(CurrentDeviceName);
        }
